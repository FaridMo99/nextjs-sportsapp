...
import { TeamAbbreviation, TeamName } from "@/lib/transformTeamName";
...
async function Roster({ teamName, abbr }: Omit<SeasonProps, "id" | "season">) {
  const roster = await getData<TeamPlayer[]>(
